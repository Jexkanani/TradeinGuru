...
@objc open class ACFloatingTextfield: UITextField {
    ...
    override open func editingRect(forBounds bounds: CGRect) -> CGRect {
        ...
        if Language == "AR" {
            return CGRect(x:-3, y:4, width:bounds.size.width, height:bounds.size.height);
        }
        else {
             return CGRect(x:4, y:4, width:bounds.size.width, height:bounds.size.height);
        }
...
//protocol ACFloatingDelegeta {
//    //MARK: - Textfield delegate methods
//    func ACtextFieldDidBeginEditing(_ textField: ACFloatingTextfield)
//    
//    func ACtextFieldShouldEndEditing(_ textField: ACFloatingTextfield) -> Bool
//    
//    func ACtextFieldShouldReturn(_ textField: ACFloatingTextfield) -> Bool
//}
//
//class ACFloating {
//    
//    weak var delegate : ACFloatingDelegeta?
//    
//    func ACTxtSatate() {
//        delegate?.ACtextFieldDidBeginEditing(txt: UITextField)
//    }
//    
//}
